...
@DynamicInsert
@DynamicUpdate
public class LivFastStateWiseSecondary 
{
	@Id
	...
	public LivFastStateWiseSecondary()
	{}

	public LivFastStateWiseSecondary(Long id, String state, int ibUpsCategory, int fourwCategory, int erickCategory) {
		//super();
		this.id = id;
		this.state = state;
