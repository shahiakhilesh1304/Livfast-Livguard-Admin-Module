...
public class LivFastDealerProduct 
{
	@Id
	 ...
	 */
	public LivFastDealerProduct(int id, String uniqueCode, String comment, Date createdTimeStamp, Date updatedTimeStamp,
	...
	public String toString() {
		return "LivFastDealerProduct [id=" + id + ", uniqueCode=" + uniqueCode + ", comment=" + comment + ", createdTimeStamp="
