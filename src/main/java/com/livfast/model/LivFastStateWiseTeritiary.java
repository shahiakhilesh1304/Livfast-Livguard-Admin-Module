...
@Component
@Entity
@Table(name= "statewise_tertiary")

@DynamicInsert
@DynamicUpdate
public class LivFastStateWiseTeritiary 
{
	@Id
	...
	public LivFastStateWiseTeritiary()
	{}

	public LivFastStateWiseTeritiary(Long id, String state, int ibUpsCategory, int fourwCategory, int erickCategory) {
		//super();
		this.id = id;
		this.state = state;
	...
	public String toString() {
		return "StateWiseTeritiary [id=" + id + ", state=" + state + ", ibUpsCategory=" + ibUpsCategory
