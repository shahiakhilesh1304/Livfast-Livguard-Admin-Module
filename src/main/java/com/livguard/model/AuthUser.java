...
public class AuthUser 
{
	...
	public AuthUser(int id, String passsword, Date lastLogin, Boolean isSuperUser, String username, String firstName,
	...
	public String toString() {
		return "AuthUser [id=" + id + ", passsword=" + passsword + ", lastLogin=" + lastLogin + ", isSuperUser="
