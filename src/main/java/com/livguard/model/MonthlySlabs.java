...
public class MonthlySlabs 
{
	 ...
	 * @param redeemDesc
	 */
	public MonthlySlabs(int id, int loyaltyPoint, Boolean isActive, Date createdTimeStamp, Date updatedTimeStamp,
	...
	public String toString() {
		return "MonthlySlabs [id=" + id + ", loyaltyPoint=" + loyaltyPoint + ", isActive=" + isActive
