...
@DynamicInsert
@DynamicUpdate
public class StateWiseTeritiary 
{
	@Id
	...
	public StateWiseTeritiary()
	{}

	public StateWiseTeritiary(Long id, String state, int ibUpsCategory, int fourwCategory, int erickCategory) {
		//super();
		this.id = id;
		this.state = state;
